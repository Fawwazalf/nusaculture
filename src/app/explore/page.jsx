  ...
  return (
    <div className="bg-[#181818] h-screen">
      ...
      <div className="mx-[117px] flex justify-between my-[55px]">
        <CardCulture
          title="WAYANG KULIT"
          prov="Provinsi Jawa Timur"
          desc="Wayang kulit adalah bentuk tradisional dari kesenian wayang yang aslinya ditemukan dalam budaya Jawa dan Bali di Indonesia. Narasi wayang kulit seringkali berkaitan dengan tema utama kebaikan melawan kejahatan."
        />
        <CardCulture
          title="WAYANG KULIT"
          prov="Provinsi Jawa Timur"
