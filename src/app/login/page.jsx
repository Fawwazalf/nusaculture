...
const page = () => {
  ...
  return (
    <div className="bg-[#181818] h-screen w-screen relative flex flex-col justify-end lg:flex-row">
      <motion.div
        className="w-full h-[720px] lg:w-[55%] lg:h-screen bg-[#20292C]/50 rounded-t-[50px] lg:rounded-r-[50px] lg:rounded-tl-none absolute lg:relative"
        initial="right"
      ...
      >
        <p className="text-[#FFF9E966]/40 font-semibold text-center mt-[27px] lg:hidden" onClick={() => setMasuk(true)}>
        ...
        <Image
          ...
          priority
          quality={100}
          className={`${masuk ? "hidden lg:inline-block rounded-l-[50px]" : "hidden lg:inline-block rounded-r-[50px]"}  `}
        ></Image>
      </motion.div>
      <div className="flex justify-between z-[1]">
        {/* <div className="flex flex-col justify-center items-center bg-[#20292C] lg:bg-transparent w-full h-[640px] lg:h-screen lg:w-[45%] rounded-t-[50px] lg:rounded-none">
          ...
          <form className="flex flex-col w-[300px] md:w-[400px]" onSubmit={handleLogin}>
            <label
              for="name"
        ...
        <div className="flex flex-col justify-center items-center bg-[#20292C] lg:bg-transparent w-full h-[640px] lg:h-screen lg:w-[45%] rounded-t-[50px] lg:rounded-none ">
          ...
          <form className="flex flex-col w-[350px] md:w-[400px]" onSubmit={handleLogin}>
            <label
              for="name"
              className="text-[#FFF9E9] text-[14px] md:text-[16px] ml-[5px] mb-[3px] font-semibold"
            >
